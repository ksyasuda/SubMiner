...
- Release CI renames the Windows portable ZIP to `SubMiner-<version>-win.zip` before upload. Keep the unqualified `SubMiner-<version>.zip` name reserved for the macOS Squirrel updater ZIP referenced by `latest-mac.yml`.
